...
import com.xie.common.core.utils.TreeBuildUtils;
...
import com.xie.system.domain.vo.MenuVo;
import com.xie.system.domain.vo.MetaVo;
import com.xie.system.domain.vo.RouterVo;
import com.xie.system.domain.vo.SysMenuVo;
import com.xie.system.mapper.SysMenuMapper;
...
//            router.setHidden("1".equals(menu.getVisible()));
            router.setName(menu.getRouterPath());
            router.setPath(menu.getRouterPath());
            router.setComponent(menu.getComponent());
//            router.setQuery(menu.getQueryParam());

            MenuVo menuVo = new MenuVo(menu.getMenuName(),menu.getIcon());
            MetaVo metaVo = new MetaVo(true,menuVo);
...
//                router.setRedirect("noRedirect");
                ...
                children.setMeta(new MetaVo(new MenuVo(menu.getMenuName())));
//                children.setQuery(menu.getQueryParam());
                childrenList.add(children);
                router.setChildren(childrenList);
            } else if (menu.getParentId().intValue() == 0 && menu.isInnerLink()) {
                router.setMeta(new MetaVo(new MenuVo(menu.getMenuName(),menu.getPath())));
